      ...
      <div className="flex">
        <div className="h-screen ">
          {allNotes ? (
            <div className="flex">
              <div
                className="text-black flex flex-row-reverse justify-items-start order-last border-[#7b7e63] focus:text-black focus:bg-[#f7f7f2] font-extralight"
                aria-selected="false"
              >
                {allNotes.map((note, idx, { setEdit }) => (
                  <>
                    <div
                      className="border-black border-[1px] rounded-md pt-2 pb-4 px-4 font-light my-3 w-[14rem] h-[13rem] text-left mr-5"
                      id="hardshadow"
                      key={idx}
